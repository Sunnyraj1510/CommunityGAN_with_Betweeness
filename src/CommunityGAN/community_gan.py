...
class CommunityGAN(object):
    def __init__(self):
        ...
        self.init_op = tf.compat.v1.group(tf.compat.v1.global_variables_initializer(), tf.compat.v1.local_variables_initializer())
    ...
    def sampling(self, args):
        ...
        subprocess.call('python /content/CommunityGAN/src/CommunityGAN/sampling.py %s' % (config.cache_filename_prefix + '.config.pkl'), shell=True)
